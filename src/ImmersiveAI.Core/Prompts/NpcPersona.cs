namespace ImmersiveAI.Core.Prompts
{
    ...
    public sealed class NpcPersona
    {
        ...
        /// <summary>True when this NPC carries an available native issue or active quest and the
        /// accept_quest / report_quest tools ride along (QuestTool). Adds a whisper that accepting
        /// aid or receiving a report requires calling the tool in that very breath.</summary>
        public bool CanBridgeQuests { get; set; }
