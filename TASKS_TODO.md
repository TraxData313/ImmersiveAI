...
NEXT UPDATE:
- [ ] По-скъпо организирана нощ - по-дълго описание за нея, по-специална, може би 10 денара 3-4 изречения, 100 5-6, 1000 7-8. Като цяло нека половината описва изненадата, романтичната обстановка на акта, а другата половина детайно акта, как потръпва като птичка в храст, как прошепваме, изтръпваме, еротиката, но пак в този чист стил, без вулгарности, а красив
